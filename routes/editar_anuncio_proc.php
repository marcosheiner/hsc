<?php 
    ...
    if (isset($_POST['editar_anuncio'])) {
        ...
        $query_edit = "UPDATE criar_anuncio SET nome_user='$post_user', tipo_anuncio='$tipo_anuncio', cidade='$cidade', cep='$cep', endereco='$endereco', numero_casa='$num_casa', bairro='$bairro', visibilidade='$visibilidade', telefone='$telefone', wpp='$wpp', valor='$valor', valor_neg='$valor_neg', qtd_comodos='$qtd_comodos' WHERE id='$id_anuncio'";
