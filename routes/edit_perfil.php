...
if (isset($_POST['btn-atualizar'])) {
    ...
    $sql_update = "UPDATE usuario SET nome_completo = '$nome_completo', nome_user = '$nome_user', email_user = '$email_user', telefone_user = '$telefone_user' WHERE id = '$id_user_session'";
